...
@Component({
  selector: 'app-paiment-collaborator-type-create-collaborator',
  templateUrl: './paiment-collaborator-type-create-collaborator.component.html'
})
export class PaimentCollaboratorTypeCreateCollaboratorComponent  implements OnInit {
