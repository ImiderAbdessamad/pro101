...
export class PaimentCollaboratorStateCreateCollaboratorComponent  implements OnInit {
   ...
   private _validPaimentCollaboratorStateStyle = true;
    ...
    public  setValidation(value: boolean){
        ...
        this.validPaimentCollaboratorStateStyle = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validatePaimentCollaboratorStateStyle();
    }
    ...
    public validatePaimentCollaboratorStateStyle(){
        if (this.stringUtilService.isEmpty(this.item.style)) {
        this.errorMessages.push('Style non valide');
        this.validPaimentCollaboratorStateStyle = false;
        } else {
            this.validPaimentCollaboratorStateStyle = true;
        }
    }
