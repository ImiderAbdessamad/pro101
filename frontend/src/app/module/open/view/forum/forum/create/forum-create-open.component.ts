...
@Component({
  selector: 'app-forum-create-open',
  templateUrl: './forum-create-open.component.html'
})
export class ForumCreateOpenComponent  implements OnInit {
	...
	constructor(private service: ForumOpenService , private collaboratorService: CollaboratorOpenService, private forumSubjectService: ForumSubjectOpenService, private forumStateService: ForumStateOpenService, private forumCommentService: ForumCommentOpenService, @Inject(PLATFORM_ID) private platformId? ) {
