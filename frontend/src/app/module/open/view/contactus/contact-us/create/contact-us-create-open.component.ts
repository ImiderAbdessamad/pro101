...
import {ContactUsOpenService} from 'src/app/shared/service/open/contactus/ContactUsOpen.service';
...
import {ContactUsCategoryOpenService} from 'src/app/shared/service/open/contactus/ContactUsCategoryOpen.service';
import {ContactUsStateDto} from 'src/app/shared/model/contactus/ContactUsState.model';
import {ContactUsStateOpenService} from 'src/app/shared/service/open/contactus/ContactUsStateOpen.service';
@Component({
  selector: 'app-contact-us-create-open',
  templateUrl: './contact-us-create-open.component.html'
})
export class ContactUsCreateOpenComponent  implements OnInit {
    ...
    private _validContactUsStateStyle = true;

	constructor(private service: ContactUsOpenService , private contactUsCategoryService: ContactUsCategoryOpenService, private contactUsStateService: ContactUsStateOpenService, @Inject(PLATFORM_ID) private platformId? ) {
    ...
    get validContactUsStateStyle(): boolean {
        return this._validContactUsStateStyle;
    }
    set validContactUsStateStyle(value: boolean) {
        this._validContactUsStateStyle = value;
    }
