...
@Component({
  selector: 'app-paiment-coupon-edit-influencer',
  templateUrl: './paiment-coupon-edit-influencer.component.html'
})
export class PaimentCouponEditInfluencerComponent implements OnInit {
