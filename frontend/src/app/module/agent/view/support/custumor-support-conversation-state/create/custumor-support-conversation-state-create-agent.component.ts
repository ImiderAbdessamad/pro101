...
@Component({
  selector: 'app-custumor-support-conversation-state-create-agent',
  templateUrl: './custumor-support-conversation-state-create-agent.component.html'
})
export class CustumorSupportConversationStateCreateAgentComponent  implements OnInit {
   ...
   private _validCustumorSupportConversationStateStyle = true;

	constructor(private service: CustumorSupportConversationStateAgentService , @Inject(PLATFORM_ID) private platformId? ) {
    ...
    public  setValidation(value: boolean){
        ...
        this.validCustumorSupportConversationStateStyle = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validateCustumorSupportConversationStateStyle();
    }
    ...
    public validateCustumorSupportConversationStateStyle(){
        if (this.stringUtilService.isEmpty(this.item.style)) {
        this.errorMessages.push('Style non valide');
        this.validCustumorSupportConversationStateStyle = false;
        } else {
            this.validCustumorSupportConversationStateStyle = true;
        }
    }
    ...
    get validCustumorSupportConversationStateStyle(): boolean {
        return this._validCustumorSupportConversationStateStyle;
    }

    set validCustumorSupportConversationStateStyle(value: boolean) {
         this._validCustumorSupportConversationStateStyle = value;
    }
