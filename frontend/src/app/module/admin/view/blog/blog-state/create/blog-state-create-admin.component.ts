...
export class BlogStateCreateAdminComponent  implements OnInit {
   ...
   private _validBlogStateStyle = true;
    ...
    public  setValidation(value: boolean){
        ...
        this.validBlogStateStyle = value;
    }
    ...
    get validBlogStateStyle(): boolean {
        return this._validBlogStateStyle;
    }

    set validBlogStateStyle(value: boolean) {
         this._validBlogStateStyle = value;
    }
