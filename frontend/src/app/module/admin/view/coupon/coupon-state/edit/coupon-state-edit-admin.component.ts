...
export class CouponStateEditAdminComponent implements OnInit {
    ...
    private _validCouponStateStyle = true;
 ...
 public edit(): void {
    ...
    public setValidation(value: boolean){
        ...
        this.validCouponStateStyle = value;
    }

    public validateForm(): void{
        this.errorMessages = new Array<string>();
        this.validateCouponStateCode();
        this.validateCouponStateStyle();
    }
    ...
    public validateCouponStateStyle(){
        if (this.stringUtilService.isEmpty(this.item.style)) {
            this.errorMessages.push('Style non valide');
            this.validCouponStateStyle = false;
        } else {
            this.validCouponStateStyle = true;
        }
    }
    ...
    get validCouponStateStyle(): boolean {
        return this._validCouponStateStyle;
    }
    set validCouponStateStyle(value: boolean) {
        this._validCouponStateStyle = value;
    }
