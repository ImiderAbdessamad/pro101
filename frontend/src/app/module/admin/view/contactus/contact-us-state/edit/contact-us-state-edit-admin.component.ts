...
@Component({
  selector: 'app-contact-us-state-edit-admin',
  templateUrl: './contact-us-state-edit-admin.component.html'
})
export class ContactUsStateEditAdminComponent implements OnInit {
 ...
 public edit(): void {
    ...
    public setValidation(value: boolean){
        ...
        this.validContactUsStateStyle = value;
    }
    ...
    public validateForm(): void{
        ...
        this.validateContactUsStateStyle();
    }
    ...
    public validateContactUsStateStyle(){
        if (this.stringUtilService.isEmpty(this.item.style)) {
            this.errorMessages.push('Style non valide');
            this.validContactUsStateStyle = false;
        } else {
            this.validContactUsStateStyle = true;
        }
    }
