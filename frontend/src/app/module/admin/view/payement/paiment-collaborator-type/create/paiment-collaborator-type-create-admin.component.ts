...
@Component({
  selector: 'app-paiment-collaborator-type-create-admin',
  templateUrl: './paiment-collaborator-type-create-admin.component.html'
})
export class PaimentCollaboratorTypeCreateAdminComponent  implements OnInit {
   ...
   private _validPaimentCollaboratorTypeStyle = true;

	constructor(private service: PaimentCollaboratorTypeAdminService , @Inject(PLATFORM_ID) private platformId? ) {
    ...
    public  setValidation(value: boolean){
        ...
        this.validPaimentCollaboratorTypeStyle = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validatePaimentCollaboratorTypeStyle();
    }
    ...
    public validatePaimentCollaboratorTypeStyle(){
        if (this.stringUtilService.isEmpty(this.item.style)) {
        this.errorMessages.push('Style non valide');
        this.validPaimentCollaboratorTypeStyle = false;
        } else {
            this.validPaimentCollaboratorTypeStyle = true;
        }
    }
    ...
    get validPaimentCollaboratorTypeStyle(): boolean {
        return this._validPaimentCollaboratorTypeStyle;
    }

    set validPaimentCollaboratorTypeStyle(value: boolean) {
         this._validPaimentCollaboratorTypeStyle = value;
    }
