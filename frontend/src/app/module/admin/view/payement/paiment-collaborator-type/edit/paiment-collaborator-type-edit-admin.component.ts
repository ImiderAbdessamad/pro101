...
@Component({
  selector: 'app-paiment-collaborator-type-edit-admin',
  templateUrl: './paiment-collaborator-type-edit-admin.component.html'
})
export class PaimentCollaboratorTypeEditAdminComponent implements OnInit {
