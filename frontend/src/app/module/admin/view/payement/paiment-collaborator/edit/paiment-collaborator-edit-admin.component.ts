...
export class PaimentCollaboratorEditAdminComponent implements OnInit {
    ...
    private _validPaimentCollaboratorStateStyle = true;
 ...
 public edit(): void {
   ...
   public async openCreatePaimentCollaboratorState(paimentCollaboratorState: string) {
        const isPermistted = await this.roleService.isPermitted('PaimentCollaboratorState', 'edit');
        if (isPermistted) {
    ...
    get validPaimentCollaboratorStateStyle(): boolean {
        return this._validPaimentCollaboratorStateStyle;
    }
    set validPaimentCollaboratorStateStyle(value: boolean) {
        this._validPaimentCollaboratorStateStyle = value;
    }
