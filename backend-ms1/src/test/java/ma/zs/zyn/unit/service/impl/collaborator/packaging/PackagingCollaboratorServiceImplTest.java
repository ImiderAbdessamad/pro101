...
@SpringBootTest
class PackagingCollaboratorServiceImplTest {

    @Mock
    private PackagingDao repository;
    private AutoCloseable autoCloseable;
    private PackagingCollaboratorServiceImpl underTest;
	...
	private Packaging constructSample(int i) {
        ...
        List<PackagingDetail> packagingDetails = IntStream.rangeClosed(1, 3)
                                             .mapToObj(id -> {
                                                ...
                                                element.setIndice(4);
                                                element.setDescription("description"+id);
                                                element.setPackagingDetailGroup(new PackagingDetailGroup(Long.valueOf(6)));
                                                return element;
                                             })
                                             .collect(Collectors.toList());
