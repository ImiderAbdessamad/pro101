...
import ma.zs.zyn.service.impl.collaborator.packaging.PackagingDetailCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.packaging.PackagingDetailRestCollaborator;
...
public class PackagingDetailRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PackagingDetailCollaboratorServiceImpl service;
    @Mock
    private PackagingDetailConverter converter;

    @InjectMocks
    private PackagingDetailRestCollaborator controller;
